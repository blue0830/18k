...
//会员资料
public class XiaJiYingKuiTongjiPanel : UserSubPanelBase {

    public const byte byRord = 10;
    //返回
    ...
    public ShaiXuanXiaJiYingKuiTongJi shaixuanpanel;
    ...
    public void show(RecordBackObj obj)
    {
        ...
        {
            XiaJiYingKuiTongJiItem script = itemGameObjs[i].GetComponent<XiaJiYingKuiTongJiItem>();
    ...
    void ProcessGameObjs(int count)
    {
        ...
        if (itemGameObjs.Count < count)
        {
            GameObject asset = (GameObject)AssetManager.Instance.LoadPrefab("subPanelMember/Items/XiaJiYingKuiTongJiItem");
            for (int i = 0; i < n; ++i)
            {
                GameObject go = Instantiate(asset) as GameObject;
    ...
    void OnNext(GameObject go)
    {
        ...
        if (_RecordBackObj.iCuePage < totalPages)
        {
            ...
            NetworkManager.Instance.LookupRecord(byRord, (byte)page, byRord, page, XiaJiYingKuiTongjiPanel.chName, XiaJiYingKuiTongjiPanel.startDate, XiaJiYingKuiTongjiPanel.endDate, (int)XiaJiYingKuiTongjiPanel.GetLastId(), XiaJiYingKuiTongjiPanel.chBySj);
            ProcessGameObjs(0);
        }
        else
        {
